...
export default function Map1() {
    ...
    const { isLoaded } = useJsApiLoader({
        googleMapsApiKey:"AIzaSyDfmFn9UBJSzFT_FuqJ-ZDbNj2TAI3BGDU",
        libraries: ['places'],
    })
            ...
            <div className="mapContainer" >
                    ...
                    {selectedPlace && (
                        ...
                        <div className='container d-flex justify-content-center'>
                                ...
                                <img
                                    className="pointer"
                                    src={'https://www.youngisthan.in/wp-content/uploads/2021/03/5cbc5ded512c0c3e8b6c782d_1555848685957-970x1213.jpg'}
                                />
